#ifndef STAN_MATH_PRIM_MAT_PROB_BERNOULLI_CLOGLOG_GLM_LPMF_HPP
#define STAN_MATH_PRIM_MAT_PROB_BERNOULLI_CLOGLOG_GLM_LPMF_HPP
 ...
 * with Bernoulli distribution and complementary log-log link function.
...
template <bool propto, typename T_n, typename T_x, typename T_beta,
          typename T_alpha>
typename return_type<T_x, T_beta, T_alpha>::type bernoulli_cloglog_glm_lpmf(
    const T_n &n, const T_x &x, const T_beta &beta, const T_alpha &alpha) {
  static const char *function = "bernoulli_cloglog_glm_lpmf";
...
bernoulli_cloglog_glm_lpmf(const T_n &n, const T_x &x, const T_beta &beta,
                         const T_alpha &alpha) {
  return bernoulli_cloglog_glm_lpmf<false>(n, x, beta, alpha);
}
}  // namespace math
}  // namespace stan
#endif
